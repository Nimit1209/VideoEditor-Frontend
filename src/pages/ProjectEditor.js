...
const ProjectEditor = () => {
  ...
  const [expandedToolSection, setExpandedToolSection] = useState(null);
...
const filteredElements = elements.filter((element) =>
  ...
  const toggleToolSection = (section) => {
    setExpandedToolSection(expandedToolSection === section ? null : section);
  };  
...
return (
  <div className="project-editor">
    ...
    <aside className={`tools-panel ${isToolsPanelOpen ? '' : 'closed'}`}>
  <div className="panel-header">
  ...
  {isToolsPanelOpen && (
    <div className="panel-content">
      <h2 onClick={() => setExpandedToolSection(null)}>Tools</h2>
      <div className="tools-sections">
        <div className="tools-section">
          <button
            className={`tool-button ${expandedToolSection === 'transform' ? 'active' : ''}`}
            data-section="transform"
            onClick={() => {
              toggleToolSection('transform');
              toggleTransformPanel();
            }}
          >
            Transform
          </button>
          {expandedToolSection === 'transform' && selectedSegment && isTransformOpen && (
        ...
        <div className="tools-section">
          <button
            className={`tool-button ${expandedToolSection === 'filters' ? 'active' : ''}`}
            data-section="filters"
            onClick={() => {
              toggleToolSection('filters');
              toggleFiltersPanel();
            }}
          >
            Filters
          </button>
          {expandedToolSection === 'filters' && isFiltersOpen && (
        ...
        <div className="tools-section">
          <button
            className={`tool-button ${expandedToolSection === 'text' ? 'active' : ''}`}
            data-section="text"
            onClick={() => {
              toggleToolSection('text');
              toggleTextTool();
            }}
          ...
          {expandedToolSection === 'text' && isTextToolOpen && selectedSegment && selectedSegment.type === 'text' && (
        ...
        <div className="tools-section">
          <button
            className={`tool-button ${expandedToolSection === 'transitions' ? 'active' : ''}`}
            data-section="transitions"
            onClick={() => {
              toggleToolSection('transitions');
              toggleTransitionsPanel();
            }}
          >
            Transitions
          </button>
          {expandedToolSection === 'transitions' && isTransitionsOpen && (
